...
async function resetDatabase() {
  ...
  try {
    ...
    await query(`
      ...
      VALUES ('test@laba.it', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Mario', 'Rossi', '1234567890', 'MAT001', 'user', 'Fotografia') -- Hash password di test - NON USARE IN PRODUZIONE
